...
// .chemycode-memory/ folder. This persists across the session so the
...
toolRegistry.register(
  {
    ...
    description:
      'Record a note or test result to the workspace\'s .chemycode-memory/ folder. ' +
      'Use this to document what you tested, what worked, what failed, and any observations. ' +
      'The note is appended to .chemycode-memory/notes.md and also logged in history.log. ' +
