...
//
// Code blocks are wrapped in our existing <chemcode-code-block> component
...
@customElement('chemcode-markdown-renderer')
export class MarkdownRenderer extends LitElement {
  ...
  // is for child <chemcode-code-block> instances that we don't actually use
